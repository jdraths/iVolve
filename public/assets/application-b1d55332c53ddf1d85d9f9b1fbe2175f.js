...
(function() {
  jQuery(function() {
    Morris.Line({
      ...
      xkey: 'created_at',
      ykeys: ['num_friends', 'num_followers', 'tweets_sent', 'tweets_favd', 'num_lists'],
    ...
    Morris.Line({
      ...
      xkey: 'created_at',
      ykeys: ['fb_friends', 'fb_likes', 'fb_posts', 'fb_statuses'],
    ...
    Morris.Line({
      ...
      xkey: 'created_at',
      ykeys: ['insta_followers', 'insta_following', 'insta_media', 'insta_likes'],
    ...
    return Morris.Line({
      ...
      xkey: 'created_at',
      ykeys: ['foursquare_friends', 'foursquare_following', 'foursquare_checkins', 'foursquare_badges', 'foursquare_mayor', 'foursquare_tips', 'foursquare_photos'],
